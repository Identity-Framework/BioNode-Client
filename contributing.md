...
The BioNode project welcomes new contributors.  This document will guide you
through the process.


### FORK

Fork the project [on GitHub](https://github.com/Identity-Framework/BioNode) and check out
your copy.

```sh
$ git clone git@github.com:username/BioNode.git
$ cd BioNode
$ git remote add upstream git://github.com/Identity-Framework/BioNode.git
```
...
Go to https://github.com/username/BioNode and select your feature branch.  Click
...
[issue tracker]: https://github.com/Identity-Framework/BioNode/issues
[BioNode mailing list]: (TODO: Create mailing list)
[project maintainers]: https://github.com/Identity-Framework/BioNode/wiki/Contributors
